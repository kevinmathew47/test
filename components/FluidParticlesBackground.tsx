...
export default function FluidParticlesBackground({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.fillStyle = "rgba(19, 19, 19, 0.12)";
      ...
      for (const particle of particles) {
        ...
        const opacity = Math.sin(lifeRatio * Math.PI) * 0.2;
        ...
        // Draw particle in neon green (#B6FF00 = rgb(182, 255, 0))
        ctx.fillStyle = `rgba(182, 255, 0, ${opacity})`;
        ctx.beginPath();
        ...
        if (particle.size > 1.5) {
          ...
          glow.addColorStop(0, `rgba(182, 255, 0, ${opacity * 0.5})`);
